            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  @endif
                  <!--begin::Form-->
                  <form class="needs-validation" action="{{ route('pemasukan.update', $pemasukan->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Body-->
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        <div class="col-md-6">
                          ...
                          <input
                            ...
                            value="{{ $pemasukan->nomor_pemasukan }}"
                            required />
                        </div>
                        ...
                        <div class="col-md-6">
                          ...
                          <input
                            ...
                            value="{{ $pemasukan->sumber_pemasukan }}"
                            required />
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          ...
                          <select class="form-select form-select-sm" aria-label="Small select example" name="kategori">
                            ...
                            <option @if($pemasukan->kategori == 'dana_universitas') selected @endif value="dana_universitas">Dana Universitas</option>
                            <option @if($pemasukan->kategori == 'donasi_umum') selected @endif value="donasi_umum">Donasi Umum</option>
                            <option @if($pemasukan->kategori == 'sumbangan_anggota') selected @endif value="sumbangan_anggota">Sumbangan Anggota</option>
                            <option @if($pemasukan->kategori == 'usaha_kewirausahaan') selected @endif value="usaha_kewirausahaan">Usaha dan Kewirausahaan</option>
                            <option @if($pemasukan->kategori == 'sponsor') selected @endif value="sponsor">Sponsor</option>
                            <option @if($pemasukan->kategori == 'sisa_dana_kegiatan') selected @endif value="sisa_dana_kegiatan">Sisa Dana Kegiatan</option>
                          </select>
                        </div>
                        <!--end::Col -->
                        ...
                        <div class="d-flex justify-content-center gap-2">
                          <a href="{{ route('pemasukan.index') }}" class="btn btn-sm btn-orange-custom btn-uniform">Batal</a>
