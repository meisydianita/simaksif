          ...
          <div class="row">
            ...
            <div class="col-md-8 mb-3">
              <div class="card h-100">
                ...
                <form class="needs-validation" action="{{ route('bendum-update-sandi') }}" method="post">
                  @csrf
                  @method('PUT')
                  <div class="card-body">
                    <div class="row g-3">
                      ...
                      <div class="d-flex justify-content-center gap-2">
                        <a href="{{ route('ubah-sandi-bendum') }}" class="btn btn-sm btn-orange-custom btn-uniform">Batal</a>
