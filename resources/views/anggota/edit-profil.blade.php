            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <!--begin::Form-->
                  <form class="needs-validation" action="{{ route('anggotaprofil.update', $anggota->id) }}" method="post" enctype="multipart/form-data" data-success>
                    @csrf
                    @method('PUT')
                    <!--begin::Body-->
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                          <a href="{{ route('profil-anggota') }}" class="btn btn-sm btn-orange-custom btn-uniform">Batal</a>
