              ...
              <div class="card">
                <div class="card-header">
                  <div class="d-flex align-items-center gap-2 w-100">
                    <form action="{{ route('surat-keluar-anggota.index') }}" method="GET" class="d-flex align-items-center gap-2 flex-grow-1">
                      <!--Search  -->
                      ...
                      <!-- Clear Filter Button -->
                      @if(request('search') || request('jenis_surat'))
                      <a href="{{ route('surat-keluar-anggota.index') }}" class="btn btn-lg btn-sm btn-default">
