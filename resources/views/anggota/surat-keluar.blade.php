                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex align-items-center gap-2 w-100">
                      <form action="{{ route('anggotasuratkeluar.index') }}" method="GET" class="d-flex align-items-center gap-2 flex-grow-1">
                        <!--Search  -->
                        ...
                        <select class="form-select form-select-sm" aria-label="Small select example" style="width: 280px"; name="jenis_surat" onchange="this.form.submit()">
                              <option selected value="">
                                ...
                                @if(request('search') || request(''))
                                    <a href="{{ route('anggotasuratkeluar.index') }}" class="btn btn-lg btn-sm btn-default">    
                                    </a>
                                @endif
                                Pilih Jenis Surat
                              </option>
