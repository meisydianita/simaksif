              ...
              <div class="card h-100">
                <div class="card-header fs-6 fw-medium">
                  ...
                  <div class="card-tools">
                    <a href="{{ route('edit-profil-anggota') }}" style="text-decoration: none; color: inherit;"><i class="fas fa-pen"></i></a>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row mb-2">
                    ...
                    <div class="col-md-8 fw-medium">: {{ $anggota->email }}</div>
                  </div>

                  <div class="row mb-2">
                    <div class="col-md-4 text-muted">Level</div>
                    <div class="col-md-8 fw-medium">: {{ $anggota->level }}</div>
                  </div>
